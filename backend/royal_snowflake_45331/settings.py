"""
Django settings for royal_snowflake_45331 project.
...
ROOT_URLCONF = 'royal_snowflake_45331.urls'
...
WSGI_APPLICATION = 'royal_snowflake_45331.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "royal_snowflake_45331 API",
    "DESCRIPTION": "API documentation for royal_snowflake_45331 App",
    "VERSION": "v1",
}
